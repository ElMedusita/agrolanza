return [
    ...
    | usados por la clase de validador. Algunas de estas reglas tienen múltiples versiones
    ...
    */
    ...
    'prohibited_if_declined' => 'El campo :attribute está prohibido cuando :other sea declinado.',
    ...
    'required_if_declined' => 'El campo :attribute es obligatorio cuando :other sea declinado.',
    ...
    | la convención "attribute.rule" para nombrar las líneas. Esto facilita la especificación
    | de una línea de lenguaje personalizada para una regla específica de un atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se usan para reemplazar el marcador de posición de los atributos
    | con algo más amigable, como "Dirección de correo electrónico" en lugar de "email". Esto simplemente
